...
- after the persisted target-side partial-cache follow-up:
  ...
  - exact cached progress reached `14 / 65` windows
  - ordinary resumed advances still cost approximately `84.06`, `93.39`, `111.81`, `124.94`, `136.17`, and `160.05` seconds
  - singular-pivot recovery rebases cost approximately `140.81`, `154.61`, `188.13`, `221.46`, `238.43`, and `254.55` seconds
...
- the first fourteen completed windows are consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

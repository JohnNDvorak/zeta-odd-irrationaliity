...
- after the persisted target-side partial-cache follow-up:
  ...
  - exact cached progress reached `10 / 65` windows
  - ordinary resumed advances still cost approximately `84.06`, `93.39`, `111.81`, and `124.94` seconds
  - singular-pivot recovery rebases cost approximately `140.81`, `154.61`, `188.13`, and `221.46` seconds
...
- the first ten completed windows are consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

...
- raw/logs/bz_phase2_sym4_sixteen_window_target_partial_cache_followup_note__20260410_154028.md
...
- after the persisted target-side partial-cache follow-up:
  ...
  - exact cached progress reached `11 / 65` windows
  - ordinary resumed advances still cost approximately `84.06`, `93.39`, `111.81`, and `124.94` seconds
  - singular-pivot recovery rebases cost approximately `140.81`, `154.61`, `188.13`, `221.46`, and `238.43` seconds
...
- the first eleven completed windows are consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

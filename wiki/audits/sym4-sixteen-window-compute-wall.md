...
- exact cached progress reached `60 / 65` windows
  ...
  - singular-pivot recovery rebases cost approximately `140.81`, `154.61`, `188.13`, `221.46`, `238.43`, `254.55`, `265.43`, `306.43`, `320.45`, `359.54`, `381.81`, `418.63`, `458.46`, `477.21`, `512.50`, `584.00`, `632.52`, `680.27`, `730.43`, `779.59`, `813.01`, and `1110.89` seconds
...
- the current persisted point is now `60 / 65`, with `state_window_index = 59`, `next_window_index = 60`, and `lead = 0` after the latest ordinary advance
...
- the persisted path through sixty completed windows is consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

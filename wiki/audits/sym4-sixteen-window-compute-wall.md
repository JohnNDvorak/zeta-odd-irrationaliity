...
- after the persisted target-side partial-cache follow-up:
  ...
  - exact cached progress reached `25 / 65` windows
...
- the first twenty-five completed windows are consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

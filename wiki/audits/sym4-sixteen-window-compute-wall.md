...
- after the persisted target-side partial-cache follow-up:
  ...
  - exact cached progress reached `32 / 65` windows
...
- the first thirty-two completed windows are consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

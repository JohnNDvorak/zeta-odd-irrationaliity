...
- raw/logs/bz_phase2_sym4_sixteen_window_target_partial_cache_followup_note__20260411_123424.md
...
- after the persisted target-side partial-cache follow-up:
  ...
  - exact cached progress reached `15 / 65` windows
  - ordinary resumed advances still cost approximately `84.06`, `93.39`, `111.81`, `124.94`, `136.17`, and `160.05` seconds
...
- the first fifteen completed windows are consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

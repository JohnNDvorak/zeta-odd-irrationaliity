...
- exact cached progress reached `61 / 65` windows
  - ordinary resumed advances still cost approximately `84.06`, `93.39`, `111.81`, `124.94`, `136.17`, `160.05`, `166.79`, `191.74`, `202.42`, `230.96`, `251.87`, `272.83`, `299.93`, `293.86`, `340.60`, `417.41`, `424.29`, `442.24`, `476.93`, `514.80`, `532.76`, `550.08`, `606.79`, `709.99`, and `733.21` seconds
...
- the current persisted point is now `61 / 65`, with `state_window_index = 60`, `next_window_index = 61`, and nonzero lead after the latest rebase advance
...
- the persisted path through sixty-one completed windows is consistent with an alternating rebase / ordinary-step pattern rather than a one-off singularity

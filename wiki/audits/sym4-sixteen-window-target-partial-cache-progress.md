...
- Current banked progress in the latest raw follow-up note: `33 / 65` exact windows
...
- Singular-pivot recovery steps have now cost about `140.81s`, `154.61s`, `188.13s`, `221.46s`, `238.43s`, `254.55s`, `265.43s`, `306.43s`, `320.45s`, `359.54s`, `381.81s`, `418.63s`, `458.46s`, `477.21s`, `512.50s`, and `584.00s`.
...
- Through the first thirty-three completed windows, the observed cache pattern still alternates:
  - rebase step
  - ordinary step
  - rebase step
  - ordinary step
- After the thirty-third completed window, the cached lead is nonzero again, so the next quartic step is predicted to be an ordinary advance.

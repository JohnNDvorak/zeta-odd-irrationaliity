...
- Current banked progress in the latest raw follow-up note: `24 / 65` exact windows
...
- Through the first twenty-four completed windows, the observed cache pattern still alternates:
  - rebase step
  - ordinary step
  - rebase step
  - ordinary step
- After the twenty-fourth completed window, the cached lead is zero again, so the next quartic step is predicted to be a rebase.

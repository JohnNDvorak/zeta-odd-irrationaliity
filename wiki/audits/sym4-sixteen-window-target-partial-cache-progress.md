...
- Current banked progress in the latest raw follow-up note: `26 / 65` exact windows
...
- Through the first twenty-six completed windows, the observed cache pattern still alternates:
  - rebase step
  - ordinary step
  - rebase step
  - ordinary step
- After the twenty-sixth completed window, the cached lead is zero again, so the next quartic step is predicted to be a rebase.

...
- current exact progress reached during this tranche: `20 / 65` windows
...
- the nineteenth completed window lifts the rebase high-water mark again, to approximately `320.45s`

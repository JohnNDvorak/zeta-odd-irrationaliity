...
- Gate id: `bz_phase2_sym2_seven_window_affine_decision_gate`
- Source probe: `/Users/john.n.dvorak/Documents/Git/zeta5-autoresearch/data/logs/bz_phase2_sym2_seven_window_affine_matrix_recurrence_screen.md`
...
Keep the Sym^2-lifted object only if there is a genuinely different nonlocal family beyond both the homogeneous and affine matrix ladders. Otherwise pivot again to a different beyond-Plucker invariant family.

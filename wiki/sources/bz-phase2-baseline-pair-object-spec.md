---
title: Phase 2 baseline pair object spec
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_baseline_pair_object_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_baseline_pair_object_spec.md`
- Source kind: `logs`
- Phase tag: `2`

---
title: Phase 2 Sym^2-lifted seven-window matrix recurrence screen
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_sym2_seven_window_matrix_recurrence_screen.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_sym2_seven_window_matrix_recurrence_screen.md`
- Source kind: `logs`
- Phase tag: `2`

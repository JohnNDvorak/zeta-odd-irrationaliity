---
title: Phase 2 symmetric source packet object spec
category: source
phase: '2'
direction: '11'
sources:
...
Source snapshot for `raw/logs/bz_phase2_symmetric_source_packet_object_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_symmetric_source_packet_object_spec.md`
- Source kind: `logs`
- Phase tag: `2`
- Direction tag: `11`

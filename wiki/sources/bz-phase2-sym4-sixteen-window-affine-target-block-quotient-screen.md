---
title: Phase 2 Sym^4-lifted affine target block quotient screen
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_sym4_sixteen_window_affine_target_block_quotient_screen.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_sym4_sixteen_window_affine_target_block_quotient_screen.md`
- Source kind: `logs`
- Phase tag: `2`

---
title: Phase 2 baseline full-packet object spec
category: source
phase: '2'
direction: '10'
sources:
...
Source snapshot for `raw/logs/bz_phase2_baseline_full_packet_object_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_baseline_full_packet_object_spec.md`
- Source kind: `logs`
- Phase tag: `2`
- Direction tag: `10`

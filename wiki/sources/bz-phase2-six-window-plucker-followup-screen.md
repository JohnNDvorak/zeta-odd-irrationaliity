---
title: Phase 2 six-window Plucker follow-up screen
category: source
phase: '2'
direction: '13'
sources:
...
Source snapshot for `raw/logs/bz_phase2_six_window_plucker_followup_screen.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_six_window_plucker_followup_screen.md`
- Source kind: `logs`
- Phase tag: `2`
- Direction tag: `13`

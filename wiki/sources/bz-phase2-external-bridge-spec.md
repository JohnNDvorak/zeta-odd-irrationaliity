---
title: Phase 2 external bridge spec
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_external_bridge_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_external_bridge_spec.md`
- Source kind: `logs`
- Phase tag: `2`

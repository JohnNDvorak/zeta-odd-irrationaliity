---
title: Phase 2 Sym^2-lifted eight-window object spec
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_sym2_eight_window_object_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_sym2_eight_window_object_spec.md`
- Source kind: `logs`
- Phase tag: `2`

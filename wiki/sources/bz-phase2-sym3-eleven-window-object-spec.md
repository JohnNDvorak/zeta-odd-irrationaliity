---
title: Phase 2 Sym^3-lifted eleven-window object spec
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_sym3_eleven_window_object_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_sym3_eleven_window_object_spec.md`
- Source kind: `logs`
- Phase tag: `2`

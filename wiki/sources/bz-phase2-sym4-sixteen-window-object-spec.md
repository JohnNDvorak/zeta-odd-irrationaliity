---
title: Phase 2 Sym^4-lifted sixteen-window object spec
category: source
phase: '2'
direction: frontier
sources:
...
Source snapshot for `raw/logs/bz_phase2_sym4_sixteen_window_object_spec.md`.

## Snapshot role

- Raw snapshot: `raw/logs/bz_phase2_sym4_sixteen_window_object_spec.md`
- Source kind: `logs`
- Phase tag: `2`

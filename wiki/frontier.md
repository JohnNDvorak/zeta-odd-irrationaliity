...
- raw/logs/bz_phase2_sym4_sixteen_window_target_partial_cache_followup_note__20260413_110237.md
...
- Current quartic engineering subfrontier: the target-side cached continuation is tracked in
  [[sym4-sixteen-window-target-partial-cache-progress]], with persisted exact progress through `21 / 65` windows.
...
- The attempted Sym^4 sixteen-window continuation is currently an engineering blocker, but the target-side cache path is now real:
  ...
  - the target side remains too expensive to bank as a full object:
    ...
    - cached exact progress has now reached `21 / 65` windows
    - ordinary resumed advances are now about `84.06`, `93.39`, `111.81`, `124.94`, `136.17`, `160.05`, `166.79`, `191.74`, and `202.42` seconds
    - singular-pivot rebases are now about `140.81`, `154.61`, `188.13`, `221.46`, `238.43`, `254.55`, `265.43`, `306.43`, `320.45`, and `359.54` seconds
  ...
  - live timing therefore narrows the quartic wall further:
    ...
    - the latest rebase rose to about `359.54` seconds, extending the new higher rebase band
    - the latest ordinary step rose to about `202.42` seconds, extending the new higher ordinary-step band
